...
const Projects = () => {
  ...
  const projects = [
    ...
    { id: 2, img: p3, title: 'Find My Stay', description: 'Your simple way to discover the perfect place to crash! 🛏️🔍', link: 'https://hardeepkaur28.github.io/FindMyStay/' },
    ...
    { id: 6, img: p2, title: 'E-Commerce Website', description: 'A seamless online musics experience with a modern UI.', link: 'https://hardeepkaur28.github.io/magenta-lime-music-site/' },
    { id: 7, img: p1, title: 'Snapnload', description: 'The best free stock photos shared by the snapnload community. 📸✨', link: 'https://hardeepkaur28.github.io/Snapnload/' },
  ];
